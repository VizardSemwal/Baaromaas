...
import { StyleSheet, Text, View ,
  Dimensions,TouchableOpacity,ScrollView, StatusBar,Linking,Image,ImageBackground,Modal,Pressable} from 'react-native'
...
const TripDescription = (props) => {
  ...
  const userinfo = useContext(AppContext)
    ...
    const [widths,setwidths]=useState(Dimensions.get('window').width)
   ...
   return (
        <View style={{flex:1}}>
          ...
          {Checked?
            ...
            style={{position:"absolute",padding:5,elevation:5,zIndex:20,top:50,right:15,backgroundColor:Colors.RED,borderRadius:20}}>
            ...
            elevation:5,zIndex:20,top:50,left:15,backgroundColor:Colors.Black,borderRadius:20}}>
...
<View style={{padding:10,backgroundColor:"#f7f7f7",
            flexDirection:"row",justifyContent:"space-between"}}>
               ...
               <Button 
               dark={false}
               style={{width:"100%",backgroundColor:Colors.YELLOW}}
               onPress={()=>{
                 ...
                 if(userinfo.Loggedin){
                  ...
                  props.navigation.navigate("Mobile",{id:props.route.params.id,price:Price,Haridwar:Haridwar,Delhi:Delhi,Base:Base})
