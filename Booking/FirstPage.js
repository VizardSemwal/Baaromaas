...
<Text>{item.BookingAmount == 0?"Full Payment":"Remaing Amount"} : ₹ {item.FullAmount}</Text>
    ...
    return (
        <View style={{flex:1}}>
         ...
         <View style={{flexDirection:"row",marginTop:40,alignItems:"center",padding:10,backgroundColor:"#f7f7f7"}}>
         <TouchableOpacity onPress={()=>props.navigation.openDrawer()}>
         <Icon name="menu" color="white" size={25} color="black" />
         </TouchableOpacity>
         <Title style={{marginLeft:15,color:"black"}}>My Booking's</Title>
         </View>    
