...
const [data,setdata]=useState({})
    ...
    return (
        <View style={{flex:1,backgroundColor:Colors.primary,marginTop:40}}>
        ...
        <View style={{padding:15,backgroundColor:"#f7f7f7",
         ...
         <Text style={{color:"black",fontSize:21,paddingLeft:15,fontWeight:"bold",alignItems:"center",justifyContent:"center"}}
